...
public class Form_Allay extends PlayerFormBase {
    ...
    public static final AbstractAnimStateController WALK_CONTROLLER = new WithSneakAnimController(new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_moving")), new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_sneaking_walk")));
    public static final AbstractAnimStateController SPRINT_CONTROLLER = new WithSneakAnimController(new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_run")), new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_sneaking_walk")));
    public static final AbstractAnimStateController IDLE_CONTROLLER = new WithSneakAnimController(new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_idle")), new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_sneaking")));
    public static final AbstractAnimStateController MINING_CONTROLLER = new OneAnimController(new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_digging")));
    public static final AbstractAnimStateController ATTACK_CONTROLLER = new OneAnimController(new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_attack")));
    public static final AbstractAnimStateController FLYING_CONTROLLER = new OneAnimController(new AnimUtils.AnimationHolderData(new Identifier(MOD_ID, "allay_sp_fly")));
