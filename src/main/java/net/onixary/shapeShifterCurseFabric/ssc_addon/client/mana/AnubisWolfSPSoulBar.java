...
public class AnubisWolfSPSoulBar implements HudRenderCallback {
	...
	private static final ResourceLocation BarTexFullID = ResourceLocation.fromNamespaceAndPath("my_addon", "textures/gui/anubis_wolf_sp_soul_bar_full.png");
	private static final ResourceLocation BarTexEmptyID = ResourceLocation.fromNamespaceAndPath("my_addon", "textures/gui/anubis_wolf_sp_soul_bar_empty.png");
	private static final ResourceLocation RESOURCE_ID = ResourceLocation.fromNamespaceAndPath("my_addon", "form_anubis_wolf_sp_soul_energy");
