...
public final class SeedEnergyEatingHandler {
    ...
    public static void register() {
        ...
        UseBlockCallback.EVENT.register((player, world, hand, hitResult) -> {
            ...
            if (player instanceof ServerPlayerEntity sp) {
                ...
                int current = net.jackcooper.shapeShifterCurseAddon.resource.ResourceBars.get(sp,
                        net.jackcooper.shapeShifterCurseAddon.resource.BarKeys.SEED);
                int max = net.jackcooper.shapeShifterCurseAddon.resource.ResourceBars.maxOf(sp,
                        net.jackcooper.shapeShifterCurseAddon.resource.BarKeys.SEED);
                if (max <= 0) max = 10;
    ...
    public static boolean onSeedEaten(ServerPlayerEntity sp, ItemStack stack) {
        ...
        net.jackcooper.shapeShifterCurseAddon.resource.ResourceBars.gain(sp,
                net.jackcooper.shapeShifterCurseAddon.resource.BarKeys.SEED, 1);
