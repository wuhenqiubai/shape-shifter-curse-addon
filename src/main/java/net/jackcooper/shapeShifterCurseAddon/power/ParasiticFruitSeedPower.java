...
public class ParasiticFruitSeedPower extends ActiveCooldownPower {
    ...
    private void healWithFx(LivingEntity target, ServerPlayerEntity caster, int hearts) {
        ...
        addEffect(target, SscAddon.BAT_REGEN_ENTRY, 60, hearts - 1, caster);
    }
    ...
    private void addEffect(LivingEntity target, RegistryEntry<StatusEffect> effect, int duration, int amplifier, ServerPlayerEntity caster) {
